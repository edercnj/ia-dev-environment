...
- [ ] [TDD] AT-1 (@GK-1): Escrever teste que valida x-dev-implement tem exatamente 3 steps (RED)
- [ ] [TDD] AT-1 (@GK-1): Reestruturar x-dev-implement/SKILL.md de 4 para 3 steps (GREEN)
- [ ] [TDD] AT-2 (@GK-2): Escrever teste que valida COMMIT como 4a fase do ciclo no Step 2 (RED)
- [ ] [TDD] AT-2 (@GK-2): Mover instrucoes de commit do Step 4 para dentro do Step 2 (GREEN)
- [ ] [TDD] AT-2 (@GK-2): Refatorar documentacao do Step 2 para clareza (REFACTOR)
- [ ] [TDD] AT-3 (@GK-3): Escrever teste que valida presenca da tabela de decisao no x-dev-implement (RED)
- [ ] [TDD] AT-3 (@GK-3): Adicionar tabela de decisao de formato de commit ao x-dev-implement/SKILL.md (GREEN)
- [ ] [TDD] AT-4 (@GK-4): Escrever teste que valida presenca da tabela de decisao no x-dev-lifecycle (RED)
- [ ] [TDD] AT-4 (@GK-4): Adicionar tabela de decisao de formato de commit ao x-dev-lifecycle/SKILL.md Phase 2 (GREEN)
- [ ] [TDD] AT-5 (@GK-5): Escrever teste que valida ordem RED antes de GREEN no formato fine-grained (RED)
- [ ] [TDD] AT-5 (@GK-5): Documentar regra de ordenacao fine-grained em ambos os skills (GREEN)
- [ ] [TDD] AT-6 (@GK-6): Escrever teste que valida backward compatibility com stories sem tabela de decisao (RED)
- [ ] [TDD] AT-6 (@GK-6): Garantir default para formato combined [TDD] quando criterio nao e explicito (GREEN)
- [ ] [TDD] AT-6 (@GK-6): Refatorar instrucoes de backward compatibility para clareza (REFACTOR)
