...
| :--- | :--- | :--- |
| `--parallel` (default) | story-0010-0002 | Execucao paralela via worktrees |
| `--sequential` | story-0010-0002 | Forcca execucao sequencial (opt-out) |
| `--overlap-threshold` | story-0010-0003 | Threshold para demotion de stories |
| `--skip-rebase` | story-0010-0004 | Pula rebase-before-merge |
| `--layer` | story-0010-0008 | Restringe implementacao a uma layer |
...
Cenario: Configuration reference lista todas as flags do epic
  ...
  ENTAO deve conter a flag "--parallel" com default "true" (origem: story-0010-0002)
  E deve conter a flag "--sequential" como opt-out (origem: story-0010-0002)
  E deve conter a flag "--overlap-threshold" com default numerico (origem: story-0010-0003)
  E deve conter a flag "--skip-rebase" (origem: story-0010-0004)
...
Cenario: Guia e consistente com skills modificados no epic
  DADO que o guia referencia a flag "--parallel" como default
  E o skill "x-dev-epic-implement/SKILL.md" define "--parallel" como default apos story-0010-0002
