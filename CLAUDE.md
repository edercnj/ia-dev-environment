...
> - Current skill names (e.g., `/x-epic-create`, `/x-task-implement`, `/x-test-e2e`) remain valid until the corresponding rename story merges. Do not pre-emptively use the new names.
