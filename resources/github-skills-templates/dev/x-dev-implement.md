...
description: >
  Implements a feature/story following project conventions. Delegates preparation
  to a subagent that reads architecture and coding knowledge packs, then implements
  layer-by-layer with intermediate compilation checks. Use for quick implementations,
  single class changes, or coding without the full review phases.
---
