...
description: >
  ...
  strategies, and request/response shaping for {project_name}.
---
...
API design conventions for {project_name} using {language_name} {language_version} with {framework_name}.
