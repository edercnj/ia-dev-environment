...
description: >
  ...
  error handling, schema design, and integration patterns for {project_name}.
---
...
Protocol conventions for {project_name} using {language_name} {language_version} with {framework_name}.
