...
### 8.1 Detailed Tasks (Multi-Agent Planning)

> Generated by `/x-story-plan`. Each task has an individual DoD and implementation guide.
> If this section is empty, sub-tasks in 8.0 are used as a fallback.

| Task ID | Description | Agent | Type | Layer | DoD | Status |
|---------|-------------|-------|------|-------|-----|--------|
| {{TASK_ID}} | {{TASK_DESCRIPTION}} | {{AGENT}} | {{TASK_TYPE}} | {{LAYER}} | {{DOD}} | {{STATUS}} |
