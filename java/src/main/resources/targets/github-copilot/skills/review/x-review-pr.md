...
Senior-level holistic review with a {review_max_score}-point rubric. This is the standalone version of Phase 6 from the x-story-implement. The Tech Lead reviews the consolidated PR diff for cross-file consistency and overall quality.
...
- `.github/skills/coding-standards/SKILL.md` -- {language_name} naming, injection, mapper conventions
