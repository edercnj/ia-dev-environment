...
name: x-ops-incident
description: >
  Guides incident response with severity-based checklists, communication
  templates, and postmortem triggers. Interactive guide for SEV1-SEV4
  incidents covering classification, response coordination, and action
  item tracking.
  Reference: `.github/skills/x-ops-incident/SKILL.md`
---
...
Conduct the team through the incident response flow. Use the `sre-engineer` agent for reliability expertise and validation.
...
- Uses `sre-engineer` agent for reliability expertise and checklist validation
