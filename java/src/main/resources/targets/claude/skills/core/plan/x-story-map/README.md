...
|---|---|
| **Category** | Planning |
| **Invocation** | `/x-story-map [epic-directory-path]` |
...
```
/x-story-map plans/epic-0012/
/x-story-map plans/epic-0012/epic-0012.md
```
...
- [x-story-epic](../x-story-epic/) — Generate the Epic with story index and dependencies
- [x-story-create](../x-story-create/) — Generate the story files consumed by this skill
- [x-dev-epic-implement](../x-dev-epic-implement/) — Execute stories following the implementation map
