...
|---|---|
| **Category** | Planning |
| **Invocation** | `/x-epic-plan [EPIC-ID] [--resume] [--story story-XXXX-YYYY]` |
...
```mermaid
flowchart TD
    START(["/x-epic-plan EPIC-ID"]) --> P0["Phase 0: Prerequisites"]
    P0 --> VALID{Valid?}
...
|----------|------|----------|
| Execution state (checkpoint) | `plans/epic-XXXX/execution-state.json` | x-epic-plan |
| Epic planning report | `plans/epic-XXXX/reports/epic-planning-report-XXXX.md` | x-epic-plan |
| Epic file update (Planning column) | `plans/epic-XXXX/EPIC-XXXX.md` | x-epic-plan |
...
- [x-dev-epic-implement](../x-dev-epic-implement/) -- Epic implementation orchestrator (consumes `execution-state.json`)
- [x-story-epic-full](../x-story-epic-full/) -- Generates epic, stories, and implementation map
- [x-story-map](../x-story-map/) -- Generates implementation map with dependency graph
