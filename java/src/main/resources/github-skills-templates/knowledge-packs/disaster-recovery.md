...
description: >
  ...
  cadence, multi-region patterns, and recovery procedures for {project_name}.
---
...
Disaster recovery patterns for {project_name} using {language_name} {language_version} with {framework_name}.
