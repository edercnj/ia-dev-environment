...
## When to Use This vs `/x-story-implement`
...
> - Read template at `.github/templates/_TEMPLATE-IMPLEMENTATION-PLAN.md` for required output format
...
When `.github/templates/_TEMPLATE-IMPLEMENTATION-PLAN.md` is **not available** (projects predating EPIC-0024):
