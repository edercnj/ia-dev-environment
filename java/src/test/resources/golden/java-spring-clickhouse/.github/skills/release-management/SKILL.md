...
description: >
  ...
  rollback procedures, and release communication for my-spring-clickhouse.
---
...
Release management practices for my-spring-clickhouse using java 21 with spring-boot.
