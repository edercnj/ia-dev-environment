...
description: >
  ...
  injection, mapper conventions, and approved libraries for my-spring-clickhouse.
---
...
Coding conventions for my-spring-clickhouse using java 21 with spring-boot 3.x.
