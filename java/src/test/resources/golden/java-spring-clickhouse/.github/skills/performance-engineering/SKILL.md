...
description: >
  ...
  regression detection, and memory management for my-spring-clickhouse.
---
...
Performance engineering patterns for my-spring-clickhouse using java 21 with spring-boot.
