...
description: >
  ...
  rollback procedures, and release communication for my-spring-hexagonal.
---
...
Release management practices for my-spring-hexagonal using java 21 with spring-boot.
