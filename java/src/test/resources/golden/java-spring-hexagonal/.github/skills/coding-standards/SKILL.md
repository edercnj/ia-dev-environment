...
description: >
  ...
  injection, mapper conventions, and approved libraries for my-spring-hexagonal.
---
...
Coding conventions for my-spring-hexagonal using java 21 with spring-boot 3.x.
