...
Provides production-grade Dockerfile patterns for my-spring-hexagonal using java 21. Covers multi-stage builds for minimal image size, security hardening with non-root users, layer optimization for fast builds, health check configuration, OCI labels, and .dockerignore templates.
...
```
## Dockerfile Review -- my-spring-hexagonal
