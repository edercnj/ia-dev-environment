...
description: >
  ...
  injection, mapper conventions, and approved libraries for my-spring-elasticsearch.
---
...
Coding conventions for my-spring-elasticsearch using java 21 with spring-boot 3.x.
