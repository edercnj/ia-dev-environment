...
description: >
  ...
  capacity planning, incident management process, and change management for my-spring-elasticsearch.
---
...
SRE practices for my-spring-elasticsearch using java 21 with spring-boot.
