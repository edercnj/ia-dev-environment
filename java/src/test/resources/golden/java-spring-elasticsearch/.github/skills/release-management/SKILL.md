...
description: >
  ...
  rollback procedures, and release communication for my-spring-elasticsearch.
---
...
Release management practices for my-spring-elasticsearch using java 21 with spring-boot.
