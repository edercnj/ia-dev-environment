...
description: >
  ...
  correlation IDs, and OpenTelemetry integration for my-spring-elasticsearch.
---
...
Observability conventions for my-spring-elasticsearch using java 21 with spring-boot.
