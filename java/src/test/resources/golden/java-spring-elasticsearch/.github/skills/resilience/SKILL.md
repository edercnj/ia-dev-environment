...
description: >
  ...
  graceful degradation, backpressure, and resilience metrics for my-spring-elasticsearch.
---
...
Resilience patterns for my-spring-elasticsearch using java 21 with spring-boot.
