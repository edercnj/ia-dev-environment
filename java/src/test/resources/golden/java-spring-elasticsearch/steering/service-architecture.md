# Service Architecture — my-spring-elasticsearch

## 1. Overview

**Service:** my-spring-elasticsearch
...
```mermaid
graph TD
    U[User / External System] -->|Request| S[my-spring-elasticsearch]
    S -->|Response| U
    S -->|Data| DB[(Database)]
...
```mermaid
graph TD
    subgraph my-spring-elasticsearch
        API[API Layer]
