...
|--------|---------|-------|--------|
| x-dev-lifecycle | Phase 1C, after Architect plan and before implementation | Architect plan (`plan-story-*.md`), story file, test plan (`tests-story-*.md`, optional) | Task breakdown file (`tasks-story-*.md`) with ordered tasks, tiers, budgets, and dependencies |
...
- [x-dev-lifecycle](../../x-dev-lifecycle/) -- orchestrator that invokes this skill during Phase 1C
