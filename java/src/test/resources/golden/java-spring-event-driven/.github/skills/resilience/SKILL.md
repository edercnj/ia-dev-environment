...
description: >
  ...
  graceful degradation, backpressure, and resilience metrics for my-spring-event-driven.
---
...
Resilience patterns for my-spring-event-driven using java 21 with spring-boot.
