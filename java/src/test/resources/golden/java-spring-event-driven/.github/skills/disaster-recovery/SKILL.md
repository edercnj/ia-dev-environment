...
description: >
  ...
  cadence, multi-region patterns, and recovery procedures for my-spring-event-driven.
---
...
Disaster recovery patterns for my-spring-event-driven using java 21 with spring-boot.
