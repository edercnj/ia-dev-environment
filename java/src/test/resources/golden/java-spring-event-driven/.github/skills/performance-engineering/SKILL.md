...
description: >
  ...
  regression detection, and memory management for my-spring-event-driven.
---
...
Performance engineering patterns for my-spring-event-driven using java 21 with spring-boot.
