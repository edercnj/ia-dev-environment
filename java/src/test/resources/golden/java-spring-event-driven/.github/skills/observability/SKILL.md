...
description: >
  ...
  correlation IDs, and OpenTelemetry integration for my-spring-event-driven.
---
...
Observability conventions for my-spring-event-driven using java 21 with spring-boot.
