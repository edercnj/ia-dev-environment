...
description: >
  ...
  capacity planning, incident management process, and change management for my-spring-event-driven.
---
...
SRE practices for my-spring-event-driven using java 21 with spring-boot.
