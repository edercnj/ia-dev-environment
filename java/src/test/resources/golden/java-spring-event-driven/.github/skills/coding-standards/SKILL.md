...
description: >
  ...
  injection, mapper conventions, and approved libraries for my-spring-event-driven.
---
...
Coding conventions for my-spring-event-driven using java 21 with spring-boot 3.x.
