...
description: >
  ...
  rollback procedures, and release communication for my-spring-event-driven.
---
...
Release management practices for my-spring-event-driven using java 21 with spring-boot.
