...
### Phase 0.5 — Planning Mode Detection
...
When `planningMode == PRE_PLANNED`, Phase 2 replaces the standard implementation flow with task-by-task execution:

1. Read `tasks-story-XXXX-YYYY.md` to get the ordered task list
2. For each TASK-NNN in dependency order:
   a. Read `task-plan-TASK-NNN-story-XXXX-YYYY.md` for Implementation Guide and DoD
...
1. Update Section 8.1 of the story file: mark each TASK-NNN as Concluida
