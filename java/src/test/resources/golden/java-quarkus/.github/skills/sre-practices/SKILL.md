...
description: >
  ...
  capacity planning, incident management process, and change management for my-quarkus-service.
---
...
SRE practices for my-quarkus-service using java 21 with quarkus.
