...
description: >
  ...
  cadence, multi-region patterns, and recovery procedures for my-quarkus-service.
---
...
Disaster recovery patterns for my-quarkus-service using java 21 with quarkus.
