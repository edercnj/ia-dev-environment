...
- Standalone: `/x-arch-update [STORY-ID]`
...
When invoked from `x-story-implement` Phase 3 (Documentation):
...
- Sister skill: `x-arch-plan` — generates the input architecture plans
