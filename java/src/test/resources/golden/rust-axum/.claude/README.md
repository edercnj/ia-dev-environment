...
This directory contains all Claude Code configuration for the **my-rust-service** project.
...
- **Behavior:** When a `.rs` file is modified, runs `cargo check` automatically
