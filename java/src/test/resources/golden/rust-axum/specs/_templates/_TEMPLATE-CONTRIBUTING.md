# Contributing to my-rust-service

Thank you for your interest in contributing to **my-rust-service**. This guide covers everything you need to get started.
...
- **Rust** 2024+ via rustup ([install](https://rustup.rs/))
