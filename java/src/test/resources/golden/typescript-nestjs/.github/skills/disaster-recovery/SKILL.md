...
description: >
  ...
  cadence, multi-region patterns, and recovery procedures for my-nestjs-service.
---
...
Disaster recovery patterns for my-nestjs-service using typescript 5 with nestjs.
