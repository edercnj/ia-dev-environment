# Contributing to my-nestjs-service

Thank you for your interest in contributing to **my-nestjs-service**. This guide covers everything you need to get started.
...
- **Node.js** 5+ ([download](https://nodejs.org/))
