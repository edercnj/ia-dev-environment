...
ia-dev-environment — CLI tool that generates .claude/ and .github/ boilerplate for AI-assisted development environments, with config-driven templates, skills, agents, hooks, and MCP server setup
