...
Testing is critical in ia-dev-environment. The project enforces strict coverage thresholds: line coverage >= 95%, branch coverage >= 90%. This skill guides test execution, coverage analysis, and gap identification.

**Condition**: Use whenever writing, running, or analyzing tests for ia-dev-environment.

## Prerequisites

- typescript test framework configured
...
- `.github/skills/testing/SKILL.md` — 8 test categories, fixture patterns, data uniqueness, typescript-specific test frameworks, assertion libraries
