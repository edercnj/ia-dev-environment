...
description: >
  ...
  typescript 5 idioms, naming patterns, constructor
  injection, mapper conventions, and approved libraries for ia-dev-environment.
---
...
Coding conventions for ia-dev-environment using typescript 5 with commander .
