...
description: >
  ...
  cadence, multi-region patterns, and recovery procedures for ia-dev-environment.
---
...
Disaster recovery patterns for ia-dev-environment using typescript 5 with commander.
