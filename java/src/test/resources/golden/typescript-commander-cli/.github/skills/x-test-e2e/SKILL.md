...
- commander test extension configured
...
- `.github/skills/testing/SKILL.md` — real vs in-memory DB decisions, fixture patterns, data uniqueness, typescript-specific test framework, assertion library, directory structure
...
- `.github/skills/x-test-e2e/SKILL.md`
