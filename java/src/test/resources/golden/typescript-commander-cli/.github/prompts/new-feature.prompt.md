...
Follow these steps to implement a new feature in **ia-dev-environment**.
...
This implements layer-by-layer following library architecture with
typescript 5 / commander.
...
- **typescript-developer** — Primary implementer
