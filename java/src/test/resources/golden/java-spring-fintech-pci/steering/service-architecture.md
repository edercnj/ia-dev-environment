# Service Architecture — my-spring-fintech-pci

## 1. Overview

**Service:** my-spring-fintech-pci
...
```mermaid
graph TD
    U[User / External System] -->|Request| S[my-spring-fintech-pci]
    S -->|Response| U
    S -->|Data| DB[(Database)]
...
```mermaid
graph TD
    subgraph my-spring-fintech-pci
        API[API Layer]
