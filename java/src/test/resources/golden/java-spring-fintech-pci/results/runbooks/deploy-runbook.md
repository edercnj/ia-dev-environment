# Deploy Runbook — my-spring-fintech-pci
...
kubectl rollout status deployment/my-spring-fintech-pci

# Verify pods are running
kubectl get pods -l app=my-spring-fintech-pci
```
...
kubectl rollout undo deployment/my-spring-fintech-pci
