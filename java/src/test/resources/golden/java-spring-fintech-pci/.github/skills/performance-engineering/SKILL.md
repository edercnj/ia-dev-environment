...
description: >
  ...
  regression detection, and memory management for my-spring-fintech-pci.
---
...
Performance engineering patterns for my-spring-fintech-pci using java 21 with spring-boot.
