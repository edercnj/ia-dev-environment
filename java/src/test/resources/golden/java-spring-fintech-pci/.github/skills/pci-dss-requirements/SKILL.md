...
PCI-DSS v4.0 requirements mapped to concrete Java code practices for my-spring-fintech-pci. Each mappable requirement includes prohibited code patterns, correct implementations, and a code reviewer checklist. Requirements 9 and 12 are organizational and include explanatory notes.
