...
name: x-review-pr
description: >
  Tech Lead holistic review with 64-point checklist covering Clean Code, SOLID,
...
Senior-level holistic review with a 64-point rubric. This is the standalone version of Phase 6 from the x-story-implement. The Tech Lead reviews the consolidated PR diff for cross-file consistency and overall quality.
...
4. REVIEW      -> Execute 64-point Tech Lead review (inline)
