...
description: >
  ...
  rollback procedures, and release communication for my-spring-fintech-pci.
---
...
Release management practices for my-spring-fintech-pci using java 21 with spring-boot.
