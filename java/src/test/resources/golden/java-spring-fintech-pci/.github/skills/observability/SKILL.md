...
description: >
  ...
  correlation IDs, and OpenTelemetry integration for my-spring-fintech-pci.
---
...
Observability conventions for my-spring-fintech-pci using java 21 with spring-boot.
