...
- `.github/skills/testing/SKILL.md` — real vs in-memory DB decisions, fixture patterns, data uniqueness, go-specific test framework, assertion library, directory structure
