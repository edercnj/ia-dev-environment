...
|---|---|
| **Category** | Planning |
| **Invocation** | `/x-dev-adr-automation [architecture-plan-path] [story-id]` |
...
```
/x-dev-adr-automation plans/epic-0012/plans/architecture-story-0012-0003.md story-0012-0003
```
...
- [x-dev-architecture-plan](../x-dev-architecture-plan/) — Generates architecture plans containing mini-ADRs
- [x-dev-arch-update](../x-dev-arch-update/) — Updates service architecture doc with ADR references
