...
Provides comprehensive CI/CD pipeline patterns for {LANGUAGE} {FRAMEWORK} projects using go-mod, enabling automated build, test, security scan, artifact management, and deployment workflows. Covers pipeline stages, language-specific optimizations, caching strategies, environment promotion, and approval gates.
