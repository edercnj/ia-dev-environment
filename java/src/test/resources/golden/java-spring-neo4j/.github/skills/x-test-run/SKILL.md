...
Testing is critical in my-spring-neo4j. The project enforces strict coverage thresholds: line coverage >= 95%, branch coverage >= 90%. This skill guides test execution, coverage analysis, and gap identification.

**Condition**: Use whenever writing, running, or analyzing tests for my-spring-neo4j.
