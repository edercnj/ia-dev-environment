...
Testing is critical in my-ktor-service. The project enforces strict coverage thresholds: line coverage >= 95%, branch coverage >= 90%. This skill guides test execution, coverage analysis, and gap identification.

**Condition**: Use whenever writing, running, or analyzing tests for my-ktor-service.

## Prerequisites

- kotlin test framework configured
...
- `.github/skills/testing/SKILL.md` — 8 test categories, fixture patterns, data uniqueness, kotlin-specific test frameworks, assertion libraries
