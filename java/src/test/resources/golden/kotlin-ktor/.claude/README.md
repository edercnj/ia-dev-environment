...
This directory contains all Claude Code configuration for the **my-ktor-service** project.
...
| `ktor-patterns` | Referenced internally by agents |
...
| **kotlin-developer** | `kotlin-developer.md` |
...
- **Behavior:** When a `.kt` file is modified, runs `./gradlew compileKotlin -q` automatically
