# Contributing to my-ktor-service

Thank you for your interest in contributing to **my-ktor-service**. This guide covers everything you need to get started.
...
- **Java JDK** 2.0+ ([download](https://adoptium.net/))
