...
description: >
  ...
  specification. Prefer this skill over the individual x-epic-create, x-story-create, or
  x-epic-map skills when the user wants all three deliverables.
---
...
Follow the instructions in `.github/skills/x-epic-create/SKILL.md`:
...
Follow the instructions in `.github/skills/x-epic-map/SKILL.md`:
