...
description: >
  ...
  correlation IDs, and OpenTelemetry integration for my-fastapi-timescale.
---
...
Observability conventions for my-fastapi-timescale using python 3.12 with fastapi.
