...
- fastapi test extension configured
...
- `.github/skills/testing/SKILL.md` — real vs in-memory DB decisions, fixture patterns, data uniqueness, python-specific test framework, assertion library, directory structure
