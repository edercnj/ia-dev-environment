...
name: x-review-pr
description: >
  Tech Lead holistic review with 57-point checklist covering Clean Code, SOLID,
...
Senior-level holistic review with a 57-point rubric. This is the standalone version of Phase 6 from the x-story-implement. The Tech Lead reviews the consolidated PR diff for cross-file consistency and overall quality.
...
- `.github/skills/coding-standards/SKILL.md` -- python naming, injection, mapper conventions
...
3. For EACH source file, read FULL content and apply 57-point checklist
...
2. **If dashboard exists (created by x-review):**
   ...
   - Update the **Tech Lead Score** section: replace placeholder `--/57 | Status: Pending` with actual score `XX/57 | Status: GO/NO-GO`
...
- This skill produces the SAME artifact as Phase 6 of `x-story-implement`
