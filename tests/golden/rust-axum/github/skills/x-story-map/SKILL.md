...
Read every story's Section 1 (Dependencies) and the Epic's story index. Build a complete
matrix:

| Story | Title | Blocked By | Blocks | Status |
| :--- | :--- | :--- | :--- | :--- |
...
| :--- | :--- | :--- | :--- | :--- |
| 0 | STORY-001, STORY-009 | Infra + API | 2 parallel | — |
