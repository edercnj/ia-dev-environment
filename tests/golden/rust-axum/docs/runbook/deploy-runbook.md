# Deploy Runbook — my-rust-service
...
3. Monitor rollout: `kubectl rollout status deployment/my-rust-service`
...
1. Roll back deployment: `kubectl rollout undo deployment/my-rust-service`
2. Verify rollback: `kubectl rollout status deployment/my-rust-service`
