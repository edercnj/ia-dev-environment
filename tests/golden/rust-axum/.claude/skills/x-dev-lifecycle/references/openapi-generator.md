...
- **Controllers** (e.g., `@Controller`, `@RestController` in axum)
...
openapi: "3.1.0"
info:
  title: "my-rust-service API"
  description: "REST API specification for my-rust-service"
  version: "1.0.0"
servers:
...
| `info.title` | `my-rust-service API` | Mandatory |
...
Map rust DTOs to JSON Schema types:
