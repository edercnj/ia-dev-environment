...
- **Controllers** (e.g., `@Controller`, `@RestController` in quarkus)
...
openapi: "3.1.0"
info:
  title: "my-quarkus-service API"
  description: "REST API specification for my-quarkus-service"
  version: "1.0.0"
servers:
...
| `info.title` | `my-quarkus-service API` | Mandatory |
