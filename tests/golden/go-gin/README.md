...
| **gin-patterns** | `/gin-patterns` | Gin-specific patterns: middleware chains, gin.Context, go-playground/validator, GORM/sqlx data access, viper config, httptest testing, centralized error handling. Internal reference for agents producing Gin code. |
