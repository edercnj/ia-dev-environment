...
- **Controllers** (e.g., `@Controller`, `@RestController` in gin)
...
info:
  ...
  description: "REST API specification for my-go-service"
  version: "1.0.0"
servers:
...
| `info.title` | `my-go-service API` | Mandatory |
...
Map go DTOs to JSON Schema types:
