...
Follow go 1.22 idiomatic conventions for formatting, constructor injection, and mapper patterns.
...
| gin-patterns | Gin-specific patterns: middleware chains, gin.Context, go-playground/validator, GORM/sqlx data access, viper config, httptest testing, centralized error handling. Internal reference for agents producing Gin code. |
...
| go-developer | Global Behavior & Language Policy |
