...
description: >
  ...
  go 1.22 idioms, naming patterns, constructor
  injection, mapper conventions, and approved libraries for my-go-service.
---
...
Coding conventions for my-go-service using go 1.22 with gin .
