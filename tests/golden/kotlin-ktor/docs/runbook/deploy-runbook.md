# Deploy Runbook — my-ktor-service
...
3. Monitor rollout: `kubectl rollout status deployment/my-ktor-service`
...
1. Roll back deployment: `kubectl rollout undo deployment/my-ktor-service`
2. Verify rollback: `kubectl rollout status deployment/my-ktor-service`
