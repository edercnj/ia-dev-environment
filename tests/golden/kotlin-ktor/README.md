...
| **ktor-patterns** | `/ktor-patterns` | Ktor-specific patterns: plugin installation, routing DSL, Exposed ORM, Koin DI, HOCON config, testApplication testing, StatusPages error handling. Internal reference for agents producing Ktor code. |
