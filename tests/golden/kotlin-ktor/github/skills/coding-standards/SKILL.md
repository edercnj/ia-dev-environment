...
description: >
  ...
  kotlin 2.0 idioms, naming patterns, constructor
  injection, mapper conventions, and approved libraries for my-ktor-service.
---
...
Coding conventions for my-ktor-service using kotlin 2.0 with ktor .
