...
- **Controllers** (e.g., `@Controller`, `@RestController` in ktor)
...
openapi: "3.1.0"
info:
  title: "my-ktor-service API"
  description: "REST API specification for my-ktor-service"
  version: "1.0.0"
servers:
...
| `info.title` | `my-ktor-service API` | Mandatory |
...
Map kotlin DTOs to JSON Schema types:
