...
Provides production-grade Kubernetes deployment patterns for my-cli-tool. Covers workload type selection, pod specifications, resource sizing for python runtime, probe configuration, autoscaling, network policies, and security contexts using vanilla Kubernetes (cloud-agnostic).
...
```
## Kubernetes Deployment Review -- my-cli-tool
