...
Manages the local development environment lifecycle for my-cli-tool. Handles starting/stopping the container orchestrator, provisioning dependencies, building the application with pip, and verifying health checks.
...
- Orchestrator (none) installed and configured
- Build tool (pip) installed for application builds
...
- [ ] Orchestrator (none) is accessible
- [ ] Application builds successfully with pip
...
```
## Environment Status -- my-cli-tool
