...
description: >
  ...
  python 3.9 idioms, naming patterns, constructor
  injection, mapper conventions, and approved libraries for my-cli-tool.
---
...
Coding conventions for my-cli-tool using python 3.9 with click 8.1.
