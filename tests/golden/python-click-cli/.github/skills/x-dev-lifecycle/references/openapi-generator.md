...
- **Controllers** (e.g., `@Controller`, `@RestController` in click)
...
openapi: "3.1.0"
info:
  title: "my-cli-tool API"
  description: "REST API specification for my-cli-tool"
  version: "1.0.0"
servers:
...
| `info.title` | `my-cli-tool API` | Mandatory |
