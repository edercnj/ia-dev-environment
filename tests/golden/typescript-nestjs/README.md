...
| **nestjs-patterns** | `/nestjs-patterns` | NestJS-specific patterns: DI with @Injectable, Prisma/TypeORM data access, Controllers with Guards/Interceptors/Pipes, @nestjs/config, Testing module, Docker build. Internal reference for agents producing NestJS code. |
