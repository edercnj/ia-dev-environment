...
- **Controllers** (e.g., `@Controller`, `@RestController` in nestjs)
...
openapi: "3.1.0"
info:
  title: "my-nestjs-service API"
  description: "REST API specification for my-nestjs-service"
  version: "1.0.0"
servers:
...
| `info.title` | `my-nestjs-service API` | Mandatory |
...
Map typescript DTOs to JSON Schema types:
