...
Provides production-grade Kustomize patterns for managing Kubernetes manifests for my-nestjs-service across multiple environments (dev, staging, prod). Covers directory structure, base and overlay organization, strategic merge patches, JSON 6902 patches, components for cross-cutting concerns, and generators for ConfigMaps and Secrets.
...
```
## Kustomize Review -- my-nestjs-service
