...
Manages the local development environment lifecycle for my-nestjs-service. Handles starting/stopping the container orchestrator, provisioning dependencies, building the application with npm, and verifying health checks.
...
- Build tool (npm) installed for application builds
- typescript 5 runtime available
...
- [ ] Application builds successfully with npm
...
```
## Environment Status -- my-nestjs-service
