# Deploy Runbook — my-nestjs-service
...
3. Monitor rollout: `kubectl rollout status deployment/my-nestjs-service`
...
1. Roll back deployment: `kubectl rollout undo deployment/my-nestjs-service`
2. Verify rollback: `kubectl rollout status deployment/my-nestjs-service`
