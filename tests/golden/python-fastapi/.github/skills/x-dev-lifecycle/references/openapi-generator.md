...
- **Controllers** (e.g., `@Controller`, `@RestController` in fastapi)
...
openapi: "3.1.0"
info:
  title: "my-fastapi-service API"
  description: "REST API specification for my-fastapi-service"
  version: "1.0.0"
servers:
...
| `info.title` | `my-fastapi-service API` | Mandatory |
...
Map python DTOs to JSON Schema types:
