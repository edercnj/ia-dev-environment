...
3. Monitor rollout: `kubectl rollout status deployment/my-fastapi-service`
...
1. Roll back deployment: `kubectl rollout undo deployment/my-fastapi-service`
2. Verify rollback: `kubectl rollout status deployment/my-fastapi-service`
