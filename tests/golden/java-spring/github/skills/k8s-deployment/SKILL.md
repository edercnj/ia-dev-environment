...
Provides production-grade Kubernetes deployment patterns for my-spring-service. Covers workload type selection, pod specifications, resource sizing for java runtime, probe configuration, autoscaling, network policies, and security contexts using vanilla Kubernetes (cloud-agnostic).
...
```
## Kubernetes Deployment Review -- my-spring-service
