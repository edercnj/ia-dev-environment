...
| **spring-patterns** | `/spring-patterns` | Spring Boot-specific patterns: Spring DI, @ConfigurationProperties, Spring Data JPA, @RestController, @ControllerAdvice, Spring AOT. Internal reference for agents producing Spring Boot code. |
