...
### DoD Local
- [ ] `x-dev-epic-implement/SKILL.md` com Phase 0.5
- [ ] `x-dev-story-implement/SKILL.md` com Phase 1.5
- [ ] Integration test simulando colisão e validando que a fase é rebaixada
- [ ] Aviso de degradação aparece no execution-state.json (campo `parallelismDowngrades`)
