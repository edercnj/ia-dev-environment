# História: Atualização de Rules 09/14/19 + criação de Rules 21/22
...
Como **plataforma**, eu quero documentar formalmente o novo branch model (`epic/XXXX`) na **Rule 21** e a convenção de visibility (`x-internal-*`) na **Rule 22**, e atualizar Rules 09 (Branching Model), 14 (Worktree Lifecycle) e 19 (Backward Compatibility) para refletir as mudanças do EPIC-0049, garantindo que invariantes sejam enforcadas por audit scripts no CI.

> **Nota de numeração:** Rule 20 já existe no repositório (`20-telemetry-privacy.md`). As novas rules usam os próximos IDs livres: 21 (Epic Branch Model) e 22 (Skill Visibility).

### 3.1 Nova Rule 21 — Epic Branch Model

Path: `java/src/main/resources/targets/claude/rules/21-epic-branch-model.md`. Conteúdo:
...
### 3.2 Nova Rule 22 — Skill Visibility

Path: `java/src/main/resources/targets/claude/rules/22-skill-visibility.md`. Conteúdo:
...
- **Valor Principal:** Documenta o novo branch model (Rule 21) e a convenção `x-internal-*` (Rule 22); garante invariante para futuras mudanças.
...
- [ ] Rules 21 e 22 criadas com conteúdo completo
...
### 6.1 Branch model documentado pela Rule 21
...
```gherkin
Cenario: Rule 21 documenta epic/* branch
  DADO 21-epic-branch-model.md existe
  QUANDO leio o conteúdo
  ENTÃO contém seções: Purpose, Branch Naming, Lifecycle, Anti-Patterns

Cenario: Rule 22 documenta convenção x-internal-*
  DADO 22-skill-visibility.md existe
  QUANDO leio o conteúdo
...
Cenario: Audit Rule 22 retorna 0 violações
...
### TASK-0049-0020-001: Criar Rule 21 (Epic Branch Model)
- **Layer:** Doc · **Test Type:** Verification · **Size:** M · **Dependencies:** —
- **Branch:** `feat/task-0049-0020-001-rule-21`
- **Files:** `rules/21-epic-branch-model.md`

### TASK-0049-0020-002: Criar Rule 22 (Skill Visibility)
- **Layer:** Doc · **Test Type:** Verification · **Size:** M · **Dependencies:** —
- **Branch:** `feat/task-0049-0020-002-rule-22`
- **Files:** `rules/22-skill-visibility.md`
...
### TASK-0049-0020-005: Audit scripts no CI (Rule 22 enforcement)
