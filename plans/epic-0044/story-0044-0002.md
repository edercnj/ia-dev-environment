...
- [ ] Worktree criado em `.claude/worktrees/story-0044-0002/` a partir de branch `feature/epic-0044-story-0044-0002-remove-resolveResourcesRoot` (Rule 14).
...
- [ ] PR aberto targeting `develop` com título `refactor(epic-0044-0002): remove deprecated ResourceResolver.resolveResourcesRoot` (RULE-005).
