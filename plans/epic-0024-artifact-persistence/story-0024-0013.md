...
- [ ] [Dev] Adicionar pre-check para implementation plan no SKILL.md do x-dev-implement
- [ ] [Dev] Adicionar pre-check para architecture plan no SKILL.md do x-dev-implement
- [ ] [Dev] Padronizar pre-check existente de test plan (formato de log consistente)
- [ ] [Dev] Implementar context injection combinada ao subagente (prioridade: impl > arch > test)
- [ ] [Dev] Implementar warning de staleness sem regeneracao
- [ ] [Dev] Implementar degradacao graceful para todas as combinacoes de planos
- [ ] [Test] Unitario: Verificar pre-check de cada tipo de plano (ausente vs. presente)
- [ ] [Test] Unitario: Verificar combinacoes da context matrix (8 combinacoes)
- [ ] [Test] Unitario: Verificar warning de staleness (mtime comparison)
- [ ] [Test] Smoke/E2E: Executar x-dev-implement com planos pre-existentes e verificar context injection
- [ ] [Doc] Atualizar SKILL.md do x-dev-implement com documentacao de pre-checks
