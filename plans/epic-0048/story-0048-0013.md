...
- Comando canônico: `grep -rn "python\|kotlin\|typescript\|rust\|golang\|\"go\"\|csharp\|dotnet" java/src/main/java`.
...
- Complementar com: `grep -rn "go\|kotlin\|typescript\|rust\|csharp\|dotnet" java/src/main/resources/targets/claude/` — espera-se 0 hits (templates foram removidos em STORY-0048-0005/0006/0007).
...
- Modificar `/Users/edercnj/workspaces/ia-dev-environment/README.md`.
...
- Modificar `/Users/edercnj/workspaces/ia-dev-environment/CLAUDE.md`.
...
- Modificar `/Users/edercnj/workspaces/ia-dev-environment/CHANGELOG.md`.
...
- [ ] `/Users/edercnj/workspaces/ia-dev-environment/README.md` atualizado, seção "Supported Stacks" reflete apenas Java + nota de v4.0.0
- [ ] `/Users/edercnj/workspaces/ia-dev-environment/CLAUDE.md` (raiz do repo) atualizado para java-only
- [ ] `/Users/edercnj/workspaces/ia-dev-environment/CHANGELOG.md` contém entrada `## [4.0.0]` com 5 sections (Added/Removed/Fixed/Changed/Breaking)
...
| `/Users/edercnj/workspaces/ia-dev-environment/README.md` editado | Doc | `grep -q "v4.0.0" README.md` retorna 0; `grep -q "java" README.md` retorna 0 |
| `/Users/edercnj/workspaces/ia-dev-environment/CLAUDE.md` editado | Doc | `grep -q "java-only\|Java-only" CLAUDE.md` retorna 0 |
...
- **Testability:** Config + VerificationTest
- **Files:**
  - `/Users/edercnj/workspaces/ia-dev-environment/CHANGELOG.md`
- **Acceptance Criteria:**
...
- **Testability:** Config + VerificationTest
- **Files:**
  - `/Users/edercnj/workspaces/ia-dev-environment/README.md`
- **Acceptance Criteria:**
...
- **Testability:** Config + VerificationTest
- **Files:**
  - `/Users/edercnj/workspaces/ia-dev-environment/CLAUDE.md`
- **Acceptance Criteria:**
