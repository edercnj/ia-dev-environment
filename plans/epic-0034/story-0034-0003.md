...
sequenceDiagram
    ...
    Dev->>Git: Edit PlatformFilter, FileCategorizer, OverwriteDetector
...
Cenario: Degenerate — PlatformFilter opera sem branches
  DADO que a story foi aplicada
  E PlatformFilter.java foi simplificado
  QUANDO o filtro é chamado com Platform.CLAUDE_CODE
  ENTÃO retorna true
  E não há branches residuais para targets removidos
```
...
6. Degenerate: PlatformFilter simplificado

### 7.2 Mandatory Scenario Categories

- [x] Degenerate cases (PlatformFilter sem branches)
...
- **REFACTOR:** `PlatformFilter` pode colapsar para um `return platform == Platform.CLAUDE_CODE;` simples.
...
- **Size:** M
- **Dependencies:** —
- **Branch:** `feat/task-0034-0003-001-delete-agents-classes`
...
- **Branch:** `feat/task-0034-0003-002-update-enum-target`
...
- **Branch:** `feat/task-0034-0003-003-delete-agents-golden`
...
- **Branch:** `feat/task-0034-0003-004-final-verify`
- **Testability:** Config + VerificationTest
