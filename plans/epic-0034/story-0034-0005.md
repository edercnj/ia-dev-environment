...
**`/Users/edercnj/workspaces/ia-dev-environment/CLAUDE.md` (raiz):**
...
- [ ] Todos os 5 grep sanity checks retornam zero (exceto workflows legítimos)
...
- [ ] `git diff main -- resources/shared/templates/` vazio (RULE-004)
...
| N/A (audit) | `TEMPLATE_TAMPER` | `resources/shared/templates/` modificado | `git diff` não-vazio |
...
sequenceDiagram
    ...
    Dev->>Grep: grep sanity checks (5 queries)
    ...
    Dev->>Git: diff resources/shared/templates/
...
Cenario: Grep sanity checks limpos
  ...
  QUANDO executo cada um dos 5 grep sanity checks documentados
...
Cenario: RULE-004 — Templates shared intactos
  ...
  E "ls resources/shared/templates/" retorna a mesma lista de arquivos do baseline
...
- **Size:** M
- **Dependencies:** —
- **Branch:** `feat/task-0034-0005-001-update-claude-md`
- **Testability:** Doc (documentação manual verificada)
- **Files:**
  - `/Users/edercnj/workspaces/ia-dev-environment/CLAUDE.md` (EDIT)
- **Acceptance Criteria:**
...
- **Branch:** `feat/task-0034-0005-002-update-rules-readme-changelog`
- **Testability:** Doc
- **Files:**
...
- **Branch:** `feat/task-0034-0005-003-regen-manifest`
...
- **Branch:** `feat/task-0034-0005-004-e2e-verify`
- **Testability:** Config + VerificationTest
- **Files:** (nenhum novo — apenas execução de checks)
- **Acceptance Criteria:**
  - [ ] `mvn clean verify` verde com coverage ≥ 95%/90%
  - [ ] Os 5 grep sanity checks retornam zero (exceto workflows)
...
- **Branch:** `feat/task-0034-0005-005-final-pr`
