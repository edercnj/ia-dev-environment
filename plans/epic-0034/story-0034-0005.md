...
|---|---------|-------------|------|-----------|-------|-----------|--------|
| 1 | TASK-0034-0005-001 | Update root CLAUDE.md (remove ~180 lines of multi-target refs) | documentation | VERIFY | cross-cutting | -- | M |
| 2 | TASK-0034-0005-002 | Update .claude/rules, README, docs, and CHANGELOG (BREAKING disclosure + migration + rollback) | documentation | VERIFY | cross-cutting | TASK-0034-0005-001 | M |
| 3 | TASK-0034-0005-003 | Regenerate expected-artifacts.json and golden files (~9500 -> ~830 entries per profile) | migration | VERIFY | adapter.test + config | TASK-0034-0005-002 | S |
| 4 | TASK-0034-0005-004 | E2E verification (build, coverage, 6 greps, CLI smoke, RULE-003 + RULE-004 invariants) | quality-gate + validation | VERIFY | cross-cutting | TASK-0034-0005-003 | M |
| 5 | TASK-0034-0005-005 | Create final epic PR with full metrics and BREAKING CHANGE migration guide | quality-gate + validation | VERIFY | cross-cutting | TASK-0034-0005-004 | S |

> Generated by `/x-story-plan` on 2026-04-10. See `plans/epic-0034/plans/tasks-story-0034-0005.md` for full breakdown.
