...
- **Testability:** Config + VerificationTest
- **Files:**
  - `java/src/main/resources/shared/config-templates/setup-config.*.yaml` (18 arquivos — EDIT para remover `copilot`; nota: baseline corrige 17 → 18)
- **Acceptance Criteria:**
  - [ ] 18 YAMLs sem referências a `copilot`
...
|---|---------|-------------|------|-----------|-------|-----------|--------|
| 1 | TASK-0034-0001-001 | Delete 8 Github*Assembler + edit AssemblerFactory (remove 2 builders + call sites) | implementation (delete) | GREEN | adapter.application | — | M |
| 2 | TASK-0034-0001-002 | Delete 15 Github*Test classes + 1 fixture (RULE-006 baseline-green pre-check) | test (delete) | GREEN | adapter.test | TASK-0034-0001-001 | M |
| 3 | TASK-0034-0001-003 | Edit Platform enum, AssemblerTarget enum, PlatformConverter, GenerateCommand, FileCategorizer, OverwriteDetector, PlatformContextBuilder (BREAKING CHANGE commit) | implementation (edit) | GREEN | domain + adapter.inbound + util | TASK-0034-0001-002 | S |
| 4 | TASK-0034-0001-004 | Delete `targets/github-copilot/` directory (~131 files) with CWE-22 symlink safety check | config (delete) | GREEN | adapter.outbound | TASK-0034-0001-003 | S |
| 5 | TASK-0034-0001-005 | Delete `.github/` golden files in 17 profiles, PRESERVING `.github/workflows/` (RULE-003 invariant check: 95 workflows files unchanged) | migration (delete) | GREEN (boundary) | adapter.test | TASK-0034-0001-003 | M |
| 6 | TASK-0034-0001-006 | Clean 18 YAMLs, run `mvn clean verify`, validate coverage ≥ 95%/90%, execute 6 acceptance tests, create PR with before/after metrics table | quality-gate + validation | VERIFY | config + test | TASK-0034-0001-004, TASK-0034-0001-005 | S |

> Generated by `/x-story-plan` on 2026-04-10 (inline multi-agent mode). See `plans/epic-0034/plans/tasks-story-0034-0001.md` for the full breakdown with augmented DoD criteria, escalation notes, and individual task plan files.

> **Reconciliation notes (post-planning):**
> - Story §3.2 originally listed 14 test classes; baseline + filesystem reports 15 tests + 1 fixture = 16 files (missed `GithubPromptsAssemblerTest.java`)
> - Story §3.7 originally listed 17 YAMLs; actual count is 18
> - `FileCategorizer.java` currently has no explicit `.github/workflows/` branch — workflows files will fall through to "Other" category after deletion; documented in TASK-003 commit body
