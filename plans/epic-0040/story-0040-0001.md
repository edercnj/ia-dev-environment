...
- [ ] Plano arquitetural (`/Users/edercnj/.claude/plans/cheerful-hopping-gadget.md`) aprovado
...
- **Size:** M
- **Dependencies:** —
- **Branch:** `feat/task-0040-0001-001-schema-draft`
...
- **Branch:** `feat/task-0040-0001-002-fixtures`
- **Testability:** Config + VerificationTest
- **Files:**
...
- **Size:** S
- **Dependencies:** TASK-0040-0001-001
- **Branch:** `feat/task-0040-0001-003-readme`
- **Testability:** Config + VerificationTest
- **Files:**
...
- **Branch:** `feat/task-0040-0001-004-smoke`
