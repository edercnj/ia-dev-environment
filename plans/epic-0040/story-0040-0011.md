...
| `--out path` | Destino (default stdout ou `plans/telemetry-trends.md`) |
...
- **Persistência:** Output em `plans/telemetry-trends.md`
...
- **Size:** S
- **Dependencies:** —
- **Branch:** `feat/task-0040-0011-001-cli`
...
- **Branch:** `feat/task-0040-0011-002-index`
...
- **Size:** M
- **Dependencies:** TASK-0040-0011-001
- **Branch:** `feat/task-0040-0011-003-detector`
...
- **Branch:** `feat/task-0040-0011-004-slowest-render`
- **Testability:** Domain + UnitTest
- **Files:**
...
- **Branch:** `feat/task-0040-0011-005-skill`
...
- **Branch:** `feat/task-0040-0011-006-smoke-perf`
