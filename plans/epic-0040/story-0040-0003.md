...
Além dos 5 hooks, dois scripts auxiliares:
- `telemetry-emit.sh` — helper stdin → NDJSON append. Usado pelos 5 hooks acima E pelas skills instrumentadas (stories 0006-0008).
- `telemetry-lib.sh` — biblioteca compartilhada com função `resolve_context()` e helpers de mascaramento regex; sourced pelos demais scripts.

**Total: 7 scripts** (`telemetry-emit`, `telemetry-lib`, `telemetry-session`, `telemetry-pretool`, `telemetry-posttool`, `telemetry-subagent`, `telemetry-stop`). A story-0040-0004 é responsável por copiar os 7 arquivos para `.claude/hooks/` via `HooksAssembler`.
...
- [ ] 7 scripts criados (`telemetry-emit`, `-lib`, `-session`, `-pretool`, `-posttool`, `-subagent`, `-stop`)
...
- **Size:** M
- **Dependencies:** —
- **Branch:** `feature/task-0040-0003-001-emit-helper`
...
- **Branch:** `feature/task-0040-0003-002-session-hook`
- **Testability:** Port + Adapter + IT
- **Files:**
...
- **Size:** M
- **Dependencies:** TASK-0040-0003-001
- **Branch:** `feature/task-0040-0003-003-tool-hooks`
- **Testability:** Port + Adapter + IT
- **Files:**
...
- **Size:** M
- **Dependencies:** TASK-0040-0003-001
- **Branch:** `feature/task-0040-0003-004-subagent-context`
- **Testability:** Port + Adapter + IT
- **Files:**
...
- **Branch:** `feature/task-0040-0003-005-docs-lint`
...
- **Size:** M
- **Dependencies:** TASK-0040-0003-002, TASK-0040-0003-003, TASK-0040-0003-004
- **Branch:** `feature/task-0040-0003-006-smoke`
