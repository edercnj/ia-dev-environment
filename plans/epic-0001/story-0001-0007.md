...
| Blocked By | Blocks |
| :--- | :--- |
| story-0001-0003 | story-0001-0008 |
...
O Resume Workflow atual (Steps 1-4) lida com estados de checkpoint como SUCCESS, FAILED, IN_PROGRESS, BLOCKED, e os status de rebase (REBASING, REBASE_SUCCESS, REBASE_FAILED). Com a eliminação dos status de rebase (story-0001-0001) e a introdução de estados de PR (story-0001-0003), o resume precisa ser atualizado para lidar com novos estados: PR criado mas não merged, PR em review, PR merged.
...
- Step 3 (checkout da branch épica) já foi removido em story-0001-0001
