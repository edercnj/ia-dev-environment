...
| Blocked By | Blocks |
| :--- | :--- |
| story-0001-0001, story-0001-0002 | story-0001-0006, story-0001-0007 |
...
- [ ] story-0001-0002 concluída (SubagentResult com prUrl/prNumber)
...
sequenceDiagram
    ...
    CP-->>Orch: story-0001-0003 (deps: 0001, 0002)

    Orch->>CP: Check story-0001-0001.status
    CP-->>Orch: SUCCESS
    Orch->>CP: Check story-0001-0001.prMergeStatus
    CP-->>Orch: OPEN (not merged yet)

    Note over Orch: story-0001-0003 NÃO é executável
    ...
    CP-->>Orch: story-0001-0003 (all deps MERGED)
    Orch->>Orch: Dispatch story-0001-0003
```
...
Cenario: Story sem dependências é sempre executável
  DADO que story-0001-0001 não tem dependências
  QUANDO getExecutableStories() é chamada
  ENTÃO story-0001-0001 aparece na lista de executáveis
  E nenhuma verificação de PR merge é feita

Cenario: Story com dependência SUCCESS mas PR não merged NÃO é executável
  DADO que story-0001-0003 depende de story-0001-0001
  E story-0001-0001 tem status SUCCESS
  E story-0001-0001 tem prMergeStatus "OPEN"
  QUANDO getExecutableStories() é chamada
  ENTÃO story-0001-0003 NÃO aparece na lista de executáveis

Cenario: Story com dependência SUCCESS e PR merged É executável
  DADO que story-0001-0003 depende de story-0001-0001 e story-0001-0002
  E ambas têm status SUCCESS
  E ambas têm prMergeStatus "MERGED"
  QUANDO getExecutableStories() é chamada
  ENTÃO story-0001-0003 aparece na lista de executáveis

Cenario: Auto-merge executa gh pr merge após review aprovada
  DADO que o orquestrador foi invocado com --auto-merge
  E story-0001-0001 completou com SUCCESS e PR #41
...
Cenario: Polling aguarda merge manual quando --auto-merge não está set
  ...
  E story-0001-0001 completou com SUCCESS e PR #41 (status OPEN)
  QUANDO o orquestrador tenta avançar
  ENTÃO entra em loop de polling com interval de 60 segundos
  E loga "Waiting for PR #41 (story-0001-0001) to be merged..."
...
Cenario: Timeout de merge bloqueia stories dependentes
  ...
  ENTÃO stories dependentes de story-0001-0001 são marcadas como BLOCKED
