...
| Blocked By | Blocks |
| :--- | :--- |
| — | story-0001-0003, story-0001-0005, story-0001-0006 |
...
sequenceDiagram
    ...
    Orch->>LC: Dispatch story-0001-0001
    LC->>LC: git checkout -b feat/story-0001-0001-desc
    LC->>LC: Implementa (9 fases)
    LC->>GH: Cria PR targeting main
    GH-->>Orch: prUrl, prNumber

    Orch->>LC: Dispatch story-0001-0002
    LC->>LC: git checkout -b feat/story-0001-0002-desc
    LC->>LC: Implementa (9 fases)
    LC->>GH: Cria PR targeting main
    GH-->>Orch: prUrl, prNumber

    alt --single-pr (legacy)
        Orch->>Orch: git checkout -b feat/epic-0001-implementation
