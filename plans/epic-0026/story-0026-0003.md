...
| Blocked By | Blocks |
| :--- | :--- |
| story-0026-0002 | story-0026-0004 |
...
- [ ] Story-0026-0002 concluída (classificação funcional)
...
| :--- | :--- | :--- | :--- | :--- |
| `classifiedFindings` | `ClassifiedFindings` | M | findings.size >= 0 | output de story-0026-0002 |
...
sequenceDiagram
    ...
    alt --dry-run
        ...
        S-->>S: Continue to fix phase (story-0026-0004)
    end
```
