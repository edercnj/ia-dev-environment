...
```json
{
  ...
  "divergences": [
    ...
    {"artifact": "implementation-map-0024.md:row-5", "from": "Pendente", "to": "Concluida"},
    {"artifact": "epic-0024.md", "from": "Em Refinamento", "to": "Concluido"}
  ],
  "divergenceCount": 33,
  "commitSha": "abc1234",
  "mode": "apply"
...
- **Acceptance Criteria:**
  ...
  - [ ] Mapeamento state.json status → LifecycleStatus:
