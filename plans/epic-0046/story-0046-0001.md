...
- Atualizar `java/src/main/resources/targets/claude/templates/_TEMPLATE-TASK.md`, `_TEMPLATE-STORY.md`, `_TEMPLATE-EPIC.md` adicionando bloco informativo no header (abaixo do campo `**Status:**`) com a matriz de transição permitida e link para Rule 22.
