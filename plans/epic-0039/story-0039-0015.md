...
- **Acceptance Criteria:**
  - [ ] Reflete 100% dos defaults novos
...
- **Acceptance Criteria:**
  - [ ] Sessão exemplo release normal end-to-end
  - [ ] Sessão exemplo hotfix end-to-end
...
- **Acceptance Criteria:**
  - [ ] `TEMPLATE_COUNT = 18`
  - [ ] 3 entries com mandatory sections corretas
...
- **Acceptance Criteria:**
  - [ ] `GoldenFileRegenerator` rodado
  - [ ] `mvn verify` verde
  - [ ] Diff revisado para garantir mudanças apenas onde esperado
...
- **Files:**
  - `CHANGELOG.md`
- **Acceptance Criteria:**
  - [ ] Entries Added/Changed/Removed cobrindo 15 stories + breaking change
...
- **Acceptance Criteria:**
  - [ ] Geração dummy de skill `x-release` num profile produz output esperado byte-for-byte
