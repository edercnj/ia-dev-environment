...
- **Acceptance Criteria:**
  - [ ] Decision table state×mergedAt → option set
  - [ ] Tratamento de erros (skill fail, 404)
...
- **Acceptance Criteria:**
  - [ ] Seção Handoff Contract em prompt-flow.md
  - [ ] Step 8 referencia handoff explicitamente
...
- **Acceptance Criteria:**
  - [ ] Mock: prompt → handoff → mergeado → continue → tag
