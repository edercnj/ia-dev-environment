...
- 3 FIX-PR consecutivos → FORCE-PROCEED aparece
...
| :--- | :--- | :--- | :--- | :--- |
| `batchGate.lastGateDecision` | `Enum` | O (novo) | `PROCEED` \| `FIX_PR` \| `ABORT` \| `FORCE_PROCEED` | `"FIX_PR"` |
...
| :--- | :--- | :--- |
| `EPIC_BATCH_FIX_LOOP_EXCEEDED` | 3 FIX-PR consecutivos no batch gate | `"Loop de fix excedeu 3 tentativas no epic ${EPIC_ID} wave ${WAVE}; apresentando opção FORCE-PROCEED"` |
...
- **Acceptance Criteria:**
  ...
  - [ ] 3 fixes consecutivos → FORCE-PROCEED
