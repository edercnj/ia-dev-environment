...
- [x] Gate de batch consolidation reescrito: menu default com 3 opções
- [x] FIX-PR handler: `Skill(skill: "x-pr-fix-epic", args: "--epic <EPIC_ID>")`
- [x] `--non-interactive` documentado
- [x] `--manual-batch-approval` depreciado com warning
- [x] `execution-state.json` do epic estendido com `batchGate` subobject
- [x] Golden regenerado + audit Rule 13 verde + audit Rule 20 parcial verde
