...
- [ ] Gate adicionado ao fim do retry loop com EXATAMENTE 3 opções canônicas (PROCEED / FIX-PR / ABORT); `description` do PROCEED explicita "Retry remediation (+2 loops)" — nome do slot invariante per RULE-002
