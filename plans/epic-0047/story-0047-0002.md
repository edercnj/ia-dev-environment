...
### 3.2 ADR-0012: flipped orientation

> **Numbering note (2026-04-21 at implementation).** This story was planned
> assuming ADR-0007 as the slot; at implementation time the actual ADR index
> showed ADR-0007 occupied by the console-progress-reporter decision, so the
> flipped-orientation ADR was written into the next free slot as
> [ADR-0012](../../adr/ADR-0012-skill-body-slim-by-default.md). Story-0047-0001
> had the same renumbering from its originally-planned ADR-0006 to ADR-0011.
> All references below use the as-implemented number.

- Local: `adr/ADR-0012-skill-body-slim-by-default.md`.
...
- [ ] 5 SKILL.md fonte reescritas como slim contract:
  - [ ] `x-test-tdd/SKILL.md` ≤ 250 linhas (exceção alinhada com TASK-0047-0002-005 — surface maior justifica)
  - [ ] `x-story-implement/SKILL.md` ≤ 250 linhas (exceção alinhada com TASK-0047-0002-006; slim contract; coordenar com A4)
...
- **Files:**
  - `java/src/test/java/dev/iadev/smoke/Epic0047CompressionSmokeTest.java` (estende a smoke iniciada em STORY-0047-0001)
- **Acceptance Criteria:**
