...
- **Acceptance Criteria:**
  - [ ] Test invoca `wc -l` equivalente sobre `java/src/main/resources/targets/claude/skills/**/SKILL.md`
  - [ ] Falha se total agregado ≥ 30.000 linhas
  - [ ] Mensagem de falha mostra total atual, gap vs target (30.000), e sugere stories pendentes do EPIC-0047
  - [ ] Cumpre RULE-047-07 (medição obrigatória ao final do épico)
  - [ ] Test integra ao `mvn test` default scope
