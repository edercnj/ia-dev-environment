# História: `x-release` Worktree para Release/Hotfix Branches ⚠️ Bloqueada por EPIC-0035

**ID:** story-0037-0008
**Chave Jira:** —
**Status:** Bloqueada (waiting EPIC-0035)
...
- **Files:**
  - `java/src/main/resources/targets/claude/skills/core/ops/x-release/references/state-file-schema.md`
- **Acceptance Criteria:**
