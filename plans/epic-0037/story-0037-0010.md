...
# Executar GoldenFileRegenerator (comando exato a ser confirmado em README.md ~L820)
mvn exec:java -Dexec.mainClass="com.example.GoldenFileRegenerator" -Dexec.classpathScope=test
# OU equivalente conforme infra atual do projeto
```
...
| Skill | Path |
| :--- | :--- |
| `x-git-worktree` | `java/src/test/resources/golden/*/.{agents,claude}/skills/x-git-worktree/SKILL.md` |
| `x-epic-implement` | `java/src/test/resources/golden/*/.{agents,claude}/skills/x-epic-implement/SKILL.md` |
| `x-story-implement` | `java/src/test/resources/golden/*/.{agents,claude}/skills/x-story-implement/SKILL.md` |
| `x-task-implement` | `java/src/test/resources/golden/*/.{agents,claude}/skills/x-task-implement/SKILL.md` |
| `x-git-push` | `java/src/test/resources/golden/*/.{agents,claude}/skills/x-git-push/SKILL.md` |
| `x-pr-fix-epic` | `java/src/test/resources/golden/*/.{agents,claude}/skills/x-pr-fix-epic/SKILL.md` |
...
### Added
- EPIC-0037: Worktree-First Branch Creation Policy. Migrate `x-epic-implement` from harness-native `Agent(isolation:"worktree")` to explicit `/x-git-worktree create|remove` calls; add `--worktree` opt-in flag to `x-story-implement`, `x-task-implement`, `x-git-push`; auto-create worktrees in `x-pr-fix-epic`; promote RULE-018 to first-class rule file `14-worktree-lifecycle.md`; document policy in ADR-0004.
...
### Changed
- `x-epic-implement` parallel dispatch now uses explicit `/x-git-worktree create|remove` instead of `Agent(isolation:"worktree")`.
...
Cenario: Smoke epic paralelo passa
  ...
  QUANDO /x-epic-implement <test-id> é executado
...
- **Files:**
  - `java/src/test/resources/golden/*/.{agents,claude}/skills/{x-epic-implement,x-git-push,x-git-worktree,x-story-implement,x-task-implement,x-pr-fix-epic}/SKILL.md`
