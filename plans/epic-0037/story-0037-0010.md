...
| `x-epic-implement` | `java/src/test/resources/golden/*/.claude/skills/x-epic-implement/SKILL.md` |
| `x-story-implement` | `java/src/test/resources/golden/*/.claude/skills/x-story-implement/SKILL.md` |
| `x-task-implement` | `java/src/test/resources/golden/*/.claude/skills/x-task-implement/SKILL.md` |
| `x-git-push` | `java/src/test/resources/golden/*/.claude/skills/x-git-push/SKILL.md` |
| `x-pr-fix-epic` | `java/src/test/resources/golden/*/.claude/skills/x-pr-fix-epic/SKILL.md` |
...
- **Files:**
  - `java/src/test/resources/golden/*/.claude/skills/{x-epic-implement,x-git-push,x-git-worktree,x-story-implement,x-task-implement,x-pr-fix-epic}/SKILL.md`
