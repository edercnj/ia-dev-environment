...
Phases:
  ...
  2. VALIDATE_DEEP     -> will run 8 checks:
                           ...
                           [4] mvn clean verify -P all-tests
...
- **Size:** M
- **Dependencies:** —
- **Branch:** `feat/task-0035-0007-001-dry-run-update`
...
- **Size:** M
- **Dependencies:** —
- **Branch:** `feat/task-0035-0007-002-error-catalog`
- **Testability:** Config + VerificationTest
- **Files:**
  - `java/src/main/resources/targets/claude/skills/core/x-release/SKILL.md`
...
- **Branch:** `feat/task-0035-0007-003-hotfix-pr-flow`
