...
jq --arg pr_merged_at "$PR_MERGED_AT" \
  '.phase = "TAGGED" | .mergedAt = $pr_merged_at | .phasesCompleted += ["RESUME_AND_TAG"]' \
...
- **Size:** S
- **Dependencies:** —
- **Branch:** `feat/task-0035-0005-001-resume-verify`
...
- **Branch:** `feat/task-0035-0005-002-tag-creation`
- **Testability:** Port + Adapter + IT
- **Files:**
  - `java/src/main/resources/targets/claude/skills/core/x-release/SKILL.md`
- **Acceptance Criteria:**
...
- **Branch:** `feat/task-0035-0005-003-resume-tests`
